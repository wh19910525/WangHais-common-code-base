...
Step 01: 把 自己的库路径添，加到 PYTHONPATH 系统环境变量 里:
#~/.bashrc
export WANGHAI_USUAL_CODE_LIBS="/home/wanghai/WangHais-common-code-base"
export PYTHONPATH=${PYTHONPATH}:"${WANGHAI_USUAL_CODE_LIBS}/python"
